...
export const metadata: Metadata = {
  metadataBase: new URL(process.env.NEXT_PUBLIC_SITE_URL ?? "https://zenthor-ai-assist.xyz"),
  title: "Zenthor AI Assist",
  description: "Zenthor AI Assist — your personal AI assistant",
