...
export const MessageContent = ({ children, className, ...props }: MessageContentProps) => (
  <div
    className={cn(
      ...
      "group-[.is-assistant]:bg-muted/45 group-[.is-assistant]:text-foreground group-[.is-assistant]:rounded-xl group-[.is-assistant]:border group-[.is-assistant]:px-4 group-[.is-assistant]:py-3",
      "group-[.is-assistant]:max-w-[88%]",
      className,
    )}
    {...props}
  >
